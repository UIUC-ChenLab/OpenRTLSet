...
class ScriptArguments:
    ...
    train_dataset_path: Optional[str] = field(
        default="./dataset.npy",
        metadata={"help": "The path to the downloaded train dataset."},
    )
    valid_dataset_path: Optional[str] = field(
        default="./dataset.npy",
        metadata={"help": "The path to the downloaded validation dataset."},
    )
...
def main(args):
    ...
    eval_dataset = Dataset.load_from_disk(args.valid_dataset_path)
